...
<div class="container mb-5">
    <div class="table-container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0"><i class="fas fa-list me-2"></i>User List</h4>
            <div class="d-flex">
            ...
            <table class="table table-bordered table-hover align-middle">
                ...
                %>
                    <tr>
                        ...
                        <td><%= gender %></td>
                        <td><%= email %></td>
                        <td class="password-cell" title="<%= password %>"><%= password %></td>
                        <td><%= contactNumber %></td>
                        <td><small><%= createdAt %></small></td>
                        <td><span class="badge bg-<%= "admin".equalsIgnoreCase(role) ? "primary" : "secondary" %>"><%= role %></span></td>
                        <td class="<%= "1".equals(active) ? "status-active" : "status-inactive" %>">
                            <%= "1".equals(active) ? "Active" : "Inactive" %>
                        </td>
                        <!-- 
                        <td class="action-btns">
                            <a href="DBUserEditController?userId=" class="btn btn-sm btn-outline-primary" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="DBUserDeleteController?userId=" class="btn btn-sm btn-outline-danger" title="Delete"
